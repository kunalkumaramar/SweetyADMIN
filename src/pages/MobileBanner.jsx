...
export default function MobileBanner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await dispatch(updateMobileBanner({ id: editing._id, bannerData: payload })).unwrap()
      } else {
        await dispatch(createMobileBanner(payload)).unwrap()
      }
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await dispatch(deleteMobileBanner(id)).unwrap()
